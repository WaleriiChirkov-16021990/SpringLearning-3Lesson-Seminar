...
public class IssuerService {
    ...
    public Issue issue(IssueRequest request) {
        ...
        Reader readerRequest = readerRepository.findById(request.getReaderId()).orElseThrow(RuntimeException::new);
        if (countBook > 0) {
        ...
        readerRequest.getBookList().add(bookRepository.findById(request.getBookId()).orElseThrow(RuntimeException::new));
    ...
    public Issue getIssueById(long id) {
        return issueRepository.findById(id).orElseThrow(RuntimeException::new);
    }
